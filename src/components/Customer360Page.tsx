...
const Customer360Page = ({ fromHub, onBack }: Customer360PageProps) => {
  return (
    <>
        ...
        <div className='max-w-[1600px] mx-auto px-8 py-6'>
          ...
          >
            ...
            <span className='text-sm font-medium'>
              {fromHub ? 'Back to Hub' : 'Back to Quote Prep'}
            </span>
          </button>

          <h1 className='text-4xl font-light text-white mb-4'>
            Hi Nirmal, Azure Services Corp has{' '}
            <span className='text-blue-400 font-semibold'>$90.5K</span> in
            active pipeline.
          </h1>
          <p className='text-base text-blue-300 leading-relaxed max-w-4xl mb-6'>
            This Gold Tier account maintains an 85% health score with $250K
            lifetime value. Cloud Migration Phase 2 is overdue and requires
            intervention. I've analyzed their engagement patterns, key contacts,
            and recent interactions to recommend the highest-impact next steps
            for account acceleration.
          </p>

          <div className='flex gap-2'>
            <button
              className='px-5 py-2.5 bg-white text-slate-900 text-xs font-normal hover:bg-blue-50 transition-colors shadow-md'
              style={{ borderRadius: '0.35rem' }}
            >
              Azure Services Corp
            </button>
            <button
              className='px-5 py-2.5 bg-slate-800 border border-slate-700 text-slate-300 text-xs font-normal hover:bg-slate-700 transition-colors'
              style={{ borderRadius: '0.35rem' }}
            >
              SecureBank Inc
            </button>
      ...
      <main className='max-w-[1600px] mx-auto px-8 py-10'>
        ...
        <div className='grid grid-cols-4 gap-5 mb-8'>
          <div className='bg-white rounded-2xl shadow-lg p-6'>
            <div className='flex items-center gap-2 mb-4'>
              ...
              <span className='text-xs uppercase tracking-wide text-blue-600 font-bold'>
                Health Score
              </span>
            </div>
        ...
        <div className='grid grid-cols-12 gap-6'>
          ...
          <div className='col-span-4 space-y-6'>
            {/* Key Contacts */}
            <div className='bg-white rounded-2xl shadow-lg p-6'>
              <h3 className='text-xs uppercase tracking-wider text-blue-600 font-bold mb-5'>
                KEY CONTACTS
              </h3>
              <div className='space-y-3'>
                <div className='p-4 bg-slate-50 border border-slate-200 rounded-xl'>
                  ...
                  <div className='flex gap-2'>
                    <button
                      className='p-2 bg-white border border-slate-200 hover:bg-blue-50 hover:border-blue-400 transition-all'
                      style={{ borderRadius: '0.35rem' }}
                    >
            ...
            <div className='bg-white rounded-2xl shadow-lg p-6'>
              ...
              <div className='space-y-5'>
                <div className='pb-5 border-b border-slate-200'>
                  <div className='flex items-center justify-between mb-2'>
                    <span className='font-bold text-sm text-slate-900'>
                      Technical call with Michael Chen
                    </span>
                  ...
                  <p className='text-sm text-slate-600 leading-relaxed'>
                    Discussed Phase 2 architecture requirements. Positive
                    sentiment detected.
                  </p>
                </div>
                ...
                <div className='pb-5 border-b border-slate-200'>
                  <div className='flex items-center justify-between mb-2'>
                    <span className='font-bold text-sm text-slate-900'>
                      Contract signed: Annual Maintenance
                    </span>
                    <span className='text-xs text-blue-600 font-medium'>
                      1 week ago
                    </span>
                  ...
                  <p className='text-sm text-slate-600 leading-relaxed'>
                    $48K ARR secured. 24-month commitment confirmed.
                  </p>
                </div>
          ...
          <div className='col-span-8 space-y-6'>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-2xl shadow-lg p-7'>
              ...
              <p className='text-slate-700 mb-6 text-base'>
                AI-driven next steps for account acceleration
              </p>
                ...
                <div className='flex items-start gap-5'>
                  ...
                  <div className='flex-1'>
                    <h3 className='text-base font-bold text-slate-900 mb-3'>
                      Stagnant Pipeline Rescue
                    </h3>
                    <p className='text-slate-700 mb-5 text-base leading-relaxed'>
                      "Cloud Migration Phase 2" is overdue. Send a personalized
                      follow-up addressing potential budget blockers mentioned
                      in previous notes.
                    </p>
                    <button
                      className='px-6 py-3 bg-slate-900 text-white text-sm font-normal hover:bg-slate-800 transition-colors flex items-center gap-2 shadow-md'
                      style={{ borderRadius: '0.35rem' }}
                    >
